...
function scatterChartTime(data,id, x_label, y_label, x_format, y_format, x_min=null, x_max=null, y_min=null, y_max=null, x_ticks, y_ticks) {
  if (y_min == null) {
      y_min=data[0].min_y - Math.abs(data[0].min_y*0.1);
  } else {
    if(data[0].min_y &&  y_min > data[0].min_y) {
  ...
  if (x_min == null) {
    console.log("Defined:" + data[0].x_min)
