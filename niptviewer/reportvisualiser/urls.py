...
urlpatterns = [
    ...
    re_path(r'^pdf/(?P<barcode>[A-Z0-9]{9})$', SampleReportPDF.as_view(template_name='reportvisualiser/sample_report.html'), name='sample_report_pdf'),
    re_path(r'^pdf/qc/(?P<barcode>[A-Z0-9]{9})$', QCReportPDF.as_view(template_name='reportvisualiser/qc_report.html'), name='qc_report_pdf'),
